...
class MessageSendingBar(QWidget):
    def __init__(self, parent=None):
        ...
        self.image_dir = getattr(sys, '_MEIPASS', os.path.dirname(os.path.abspath(__file__)))
        ...
        self.send_audio_btn.setIcon(QIcon(os.path.join(self.image_dir,'imgs', 'send.png')))
        ...
        self.go_to_record_audio_btn.setIcon(
            QIcon(os.path.join(self.image_dir,'imgs', 'mic.png')))
        ...
        self.send_text_btn.setIcon(QIcon(os.path.join(self.image_dir,'imgs', 'send.png')))
        ...
        self.cancel_record_btn.setIcon(
            QIcon(os.path.join(self.image_dir,'imgs', 'cancel.png')))
    ...
    def show_audio_duration(self):
        ...
        self.recording_animation.setIcon(
            QIcon(os.path.join(self.image_dir,'imgs', 'mic_red.png')))
    ...
    def send_text(self):
        global MESSAGE_COUNT
        pygame.mixer.music.load(os.path.join(self.image_dir,'sounds', 'sent.mp3'))
    ...
    def __init__(self, request, left=True, message_type='audio'):
        ...
        if left:
            speaker_profil_img.setIcon(
                QIcon(os.path.join(self.image_dir,'imgs', 'chatgpt.png')))
            speaker_profil_img.setIconSize(QSize(50, 50))
        else:
            speaker_profil_img.setIcon(QIcon(os.path.join(self.image_dir,'imgs', 'user.png')))
...
class Home(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        chatgpt_logo.setIcon(QIcon(os.path.join(self.image_dir,'imgs', 'chatgpt.png')))
    ...
    def add_widget_from_thread(self, request_answer):
        ...
        pygame.mixer.music.load(os.path.join(self.image_dir,'sounds', 'incoming.mp3'))
        pygame.mixer.music.play()
